...
/*   Updated: 2024/04/02 17:34:53 by alafdili         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	img_arr_init(t_element *local_img)
{
	...
	local_img->images[13] = local_img->img._enemy;
}
...
void	txr_arr_init(t_element *local_img)
{
	...
	local_img->texture[13] = local_img->txr._enemy;
}
...
void	img_init(t_element *images)
{
	...
	images->img._enemy = mlx_texture_to_image(images->mlx, images->txr._enemy);
}
...
void	txr_init(t_element *objects)
{
	...
	objects->txr._enemy = mlx_load_png(enemy);
}
